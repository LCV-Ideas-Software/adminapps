...
## 🧠 MEMÓRIA DE CONTEXTO ISOLADO (ADMINAPPS)
## 2026-04-17 — AdminHub v02.00.10 (Pages observability rollback after GHA failure)
### Escopo
Hotfix de deploy no `adminapps` após o GitHub Actions confirmar que `observability` não é suportado em config de Cloudflare Pages.
### Alterado
...
### Versão
- APP v02.00.09 → APP v02.00.10

## 2026-04-17 — AdminHub v02.00.09 (wrangler observability + traces)
### Escopo
Padronização do baseline de observabilidade Cloudflare no `adminapps`.
### Alterado
...
### Versão
- APP v02.00.08 → APP v02.00.09
## 2026-04-10 — Biome 2.x + Vitest (v02.00.08)
