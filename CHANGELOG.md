...
## [v02.00.12] - 2026-04-30
### Alterado
- `README.md` passou a seguir o novo padrão organizacional de abertura: logo harmonizado, bloco curto de status, tabela `The version history at a glance`, links públicos de release/clone corrigidos para `LCV-Ideas-Software/adminapps` e manutenção explícita do GitHub Sponsors em `lcv-leo`.

## [v02.00.11] - 2026-04-26
### Alterado
...
### Motivação
- Restaurar o deploy do `adminapps` sem reintroduzir configuração inválida para Pages.

## [v02.00.09] - 2026-04-17
### Alterado
...
### Motivação
- Alinhar o baseline de telemetria Cloudflare do `adminapps` ao padrão operacional do workspace.


## [v02.00.08] - 2026-04-10
### Adicionado
...
### Controle de versão
- `adminapps`: APP v02.00.06 → APP v02.00.07

## [v02.00.06] - 2026-04-07
### Segurança
- **Vite 8.0.3 → 8.0.7**: Correção de 3 CVEs de severidade alta/média.

### Controle de versão
- `adminapps`: APP v02.00.05 → APP v02.00.06

## [v02.00.05] - 2026-04-02
### Controle de versão
- `adminapps`: APP v02.00.04 → APP v02.00.05

## [v02.00.04] - 2026-03-31
### Corrigido
...
### Controle de versão
- `adminapps`: APP v02.00.03 → APP v02.00.04

## [v02.00.03] - 2026-03-31
### Corrigido
...
### Controle de versão
- `adminapps`: APP v02.00.02   APP v02.00.03

## [v02.00.02] — 2026-03-31
### Alterado
...
### Controle de versão
- `adminhub`: APP v02.00.01 → APP v02.00.02
...
- **Build**: saída em `dist/` (Vite) — 194KB JS (61KB gzip), 6.6KB CSS (2KB gzip), 16 módulos, <1s.
