...
- How you tested it (browser path + command output OK).
- Whether the change touches the public response shape (UI text, API response shape, D1 schema). Public surface changes need careful review.
